...
* 参考<br>
　本品はトイレ洗浄用に開発しましたが、1ボタンで赤外線信号を送信する汎用学習リモコンとしても使えます。<br>
 例として、<br>
 ・浴室乾燥機を深夜に起動<br>
 ・エアコンの起動専用<br>
 ・人感センサーが付いているので、センサーライト<br>
 ・明暗センサー(Cds)が付いているので、防犯ライト (v02のみ)<br>
 などへの応用が考えられます。
...
<h4><<動作環境>></h4>
2025/05/30 picoWにてファームウェア(v1.26.0 (2025-08-09) .uf2)　で動作確認ok<br>
2026/03/30 RPI_PICO-20251209-v1.27.0.uf2  で動作確認ok<br>
